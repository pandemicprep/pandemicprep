	...
	return (
		<div>
			<form onSubmit={handleSubmit}>
				<input placeholder='creatorId' value={creatorId} onChange={handleCreatorId} />

				<input placeholder='productId' value={productId} onChange={handleProductId} />

				<input placeholder='score' value={score} onChange={handleScore} />
